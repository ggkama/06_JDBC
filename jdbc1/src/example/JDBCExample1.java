...
public class JDBCExample1 {
	...
	public static void main(String[] args) {
		 ...
		 *  - 다룰때 CURSOR를 이용해 1행씩 접근
		 *  
		 * 4) DriverManager 클래스
		 *  - DB 연결 정보와 JDBC 드라이버를 이용해서
		 *    원하는 DB와 연결할 수 있는
		 *    Connection 객체를 만드는 역할의 객체
		 */
...
//			System.out.println(conn); // conn 객체 생성 확인
			 ...
			 * - JDBC 코드에서 SQL 작성 시
			 *   마지막에 세미콜론 작성 X
			 *   -> 작성 시 : "SQL 명령어가 올바르게 종료되지 않았습니다"에러 뜸
			 *   (왜? JDBC는 한번만 SQL을 1개씩만 실행)
			 *    => DB에 SQL전달 시 자동으로 끝에 ; 붙여줌) 
			 */
			...
			// SQLException : DB연결과 관련된 예외 중 최상위 예외
			e.printStackTrace();
			...
			// Java 프로그램 종료 후에도 계속 연결이 유지되고 있다.
